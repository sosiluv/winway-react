...
export default function OMSPage() {
    ...
    return (
        <div className="min-h-screen bg-white pt-16">
            ...
            <section className="relative py-20 bg-slate-900 text-center">
                <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h1 className="text-5xl md:text-6xl font-bold text-white mb-8 font-cormorant">
                        WinFIX | FIX Engine & Gateway
                    </h1>
                    <p className="text-xl text-slate-300 leading-relaxed mb-10">
                        Accelerate Global Markets. Connect with Precision
                    </p>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-24">
                    ...
                    <FadeIn direction="left" triggerOnce>
                        <div className="max-w-4xl">
                            ...
                            <p className="text-4xl md:text-4xl font-cormorant text-slate-900 leading-[1.65] tracking-wide">
                                WinFIX delivers ultra-reliable, low-latency FIX connectivity for global financial institutions.
                                <br></br><br></br>
                                ...
                                WinFIX ensures seamless, secure, and scalable FIX communications with full protocol flexibility
                    ...
                    <FadeIn direction="right" triggerOnce>
                        <div className="max-w-4xl ml-auto text-right">
                            ...
                            <p className="text-4xl md:text-4xl font-cormorant text-slate-900 leading-[1.65] tracking-wide">
                                Built for mission-critical trading infrastructure, WinFIX achieves microsecond-level latency,
            ...
            {/* Functions Section */}
            <section id="functions" className="py-24 bg-gray-100">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    {/* Section Header */}
                    <div className="mb-20 text-center">
                        <h2 className="text-4xl md:text-5xl font-semibold text-slate-800 mb-4 font-cormorant">
